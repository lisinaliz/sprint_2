    ...
    <div class="row">
     ...
     <div class="row"> <label style="color: black; text-align: left;margin-top:100px"><b> facebook login</label></div><hr style="color: #b0b1b2">
      ...
      <div class="col-md-3">
         ...
         <div class="col-md-3">
          <input type="text" name="bnm" class="danger" data-toggle="tooltip" data-placement="top" 
          title="The email you've enterd doesnt match with any account .sign up for a account" style="margin-left: -56px">
            </div>
     ...
     <div class="row">
          ...
          <div class="col-md-5">
                   <input type="password" value="thisistrue" style="border color: blue"></div>
          </div>
          <div class="col-md-5">
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button type="button" class="btn btn-primary" style="margin-height: -5px" id="btnlogin">login</button>or <label style="color: blue">sign up for facebook</label><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
